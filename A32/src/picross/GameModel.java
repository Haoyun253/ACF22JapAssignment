...
public class GameModel {
	...
	public void SLPoint(int state) {
		if (state == 1) {				//save state
			...
			this.Scheckerboard = this.checkerboard;
		} else if (state == 0) {		//load state
			this.point = this.Spoint;
			this.step = this.Sstep;
			this.seconds = this.Sseconds;
			this.checkerboard = this.Scheckerboard;
		} else {
			this.point = 0;
			this.step = 0;
		}
	...
	/**
	 * Method name: getCheckerboard Purpose: return the getCheckerboard Algorithm:
	 * null
	 * 
	 * @return the checkerboard of the user
	 */
	public String getCheckerboard() {		//return state
		return this.checkerboard;
	}
	
	/**
	 * Method name: getInfo Purpose: return the info Algorithm:
	 * null
	 * 
	 * @return the info of the user
	 */
	public String getInfo() {		//return state
		return ",Points: "+this.point+",time: "+this.seconds;
	}
	
	/**
	 * Method name: getSeconds Purpose: return the seconds of the user Algorithm:
	 * null
	 * 
	 * @return the seconds of the user
	 */
	public int getSeconds() {		//return state
		return this.seconds;
	}
	
	/**
	 * Method name: setSeconds Purpose: update seconds Algorithm: null
	 * 
	 * @param seconds - the number of the second
	 */
	public void setSeconds(int seconds) {		//return state
