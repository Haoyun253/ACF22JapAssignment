...
public class GameController {
	 ...
	 * Timer
	 */
	private ControllableTimer time;
	 ...
	 * @param time  Time control class
	 */
	public GameController(GameModel theModel, GameView theView,ControllableTimer time) {
		this.M = theModel;
		this.V = theView;
		this.time=time;
	}
						...
						public void mouseClicked(MouseEvent e) {
							...
							if (V.mode == 1) { // check mode
								...
								if (M.getStep() == M.getMatrixSize() * M.getMatrixSize()) {			//if all clicked
									V.infotext(V.infoField, "Game over, you got "+M.getPoint()+" points and spent "+time.getTime()+" seconds.");
